...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2020-03-19 15:53:23',NULL),('diagnostics.include_raw','OFF','2020-03-19 15:53:23',NULL),('ps_thread_trx_info.max_length','65535','2020-03-19 15:53:23',NULL),('statement_performance_analyzer.limit','100','2020-03-19 15:53:23',NULL),('statement_performance_analyzer.view',NULL,'2020-03-19 15:53:23',NULL),('statement_truncate_len','64','2020-03-19 15:53:23',NULL);
...
-- Dump completed on 2020-03-31 12:43:16
-- MySQL dump 10.13  Distrib 8.0.18, for macos10.14 (x86_64)
--
...
--
-- Table structure for table `DietFilter`
--

DROP TABLE IF EXISTS `DietFilter`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `DietFilter` (
  `diet_index` int(11) NOT NULL AUTO_INCREMENT,
  `diet_tag` text NOT NULL,
  PRIMARY KEY (`diet_index`),
  UNIQUE KEY `diet_index` (`diet_index`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `DietFilter`
--

LOCK TABLES `DietFilter` WRITE;
/*!40000 ALTER TABLE `DietFilter` DISABLE KEYS */;
INSERT INTO `DietFilter` VALUES (1,'Vegan'),(2,'Vegetarian'),(3,'Dairy Free'),(4,'Gluten Free');
/*!40000 ALTER TABLE `DietFilter` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Future_Bookings`
--
...
CREATE TABLE `Future_Bookings` (
  ...
  CONSTRAINT `future_bookings_ibfk_1` FOREIGN KEY (`Customer`) REFERENCES `userprofile` (`ID`),
  CONSTRAINT `future_bookings_ibfk_2` FOREIGN KEY (`Table_ID`) REFERENCES `tables_availabe` (`Table_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Future_Bookings`
--

LOCK TABLES `Future_Bookings` WRITE;
/*!40000 ALTER TABLE `Future_Bookings` DISABLE KEYS */;
INSERT INTO `Future_Bookings` VALUES (1,'2020-04-30 12:30:00','625738',4,6),(2,'2020-05-02 16:00:00','625738',2,2),(3,'2020-04-30 12:45:00','152846',4,7),(4,'2020-05-01 20:00:00','152846',10,11);
/*!40000 ALTER TABLE `Future_Bookings` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `Hours` (
  ...
  `Hours_worked` decimal(60,2) NOT NULL,
  PRIMARY KEY (`User_ID`),
  UNIQUE KEY `User_ID` (`User_ID`),
  CONSTRAINT `hours_ibfk_1` FOREIGN KEY (`User_ID`) REFERENCES `userprofile` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Hours` VALUES ('253647',22.00),('746394',38.50);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Menu` (
  `Menu_Number` int(11) NOT NULL AUTO_INCREMENT,
  `Menu_Item` text NOT NULL,
  `Price` decimal(60,2) NOT NULL,
  `Diet_tag` int(11) DEFAULT NULL,
  PRIMARY KEY (`Menu_Number`),
  UNIQUE KEY `Menu_Number` (`Menu_Number`),
  KEY `Diet_tag` (`Diet_tag`),
  CONSTRAINT `menu_ibfk_1` FOREIGN KEY (`Diet_tag`) REFERENCES `dietfilter` (`diet_index`)
...
INSERT INTO `Menu` VALUES (1,'Fish and Chips',8.00,NULL),(2,'Beef Burger',7.50,3),(3,'Mushroom Risotto',8.00,2),(4,'Falafel',7.00,1),(5,'Pork Meatballs',9.50,NULL),(6,'Smashed avocado',7.20,1);
...
CREATE TABLE `Past_Bookings` (
  ...
  KEY `Customer` (`Customer`),
  KEY `Table_ID` (`Table_ID`),
  CONSTRAINT `past_bookings_ibfk_1` FOREIGN KEY (`Customer`) REFERENCES `userprofile` (`ID`),
  CONSTRAINT `past_bookings_ibfk_2` FOREIGN KEY (`Table_ID`) REFERENCES `tables_availabe` (`Table_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Past_Bookings` VALUES (1,'2020-01-28 12:30:00','625738',6,9),(2,'2020-02-01 18:00:00','625738',2,1),(3,'2020-02-29 19:30:00','152846',4,5),(4,'2020-02-29 13:00:00','152846',2,1);
/*!40000 ALTER TABLE `Past_Bookings` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Tables_availabe`
--

DROP TABLE IF EXISTS `Tables_availabe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `Tables_availabe` (
...
--
-- Dumping data for table `Tables_availabe`
--

LOCK TABLES `Tables_availabe` WRITE;
/*!40000 ALTER TABLE `Tables_availabe` DISABLE KEYS */;
INSERT INTO `Tables_availabe` VALUES (1,2),(2,2),(3,2),(4,2),(5,4),(6,4),(7,4),(8,4),(9,8),(10,8),(11,10);
/*!40000 ALTER TABLE `Tables_availabe` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `UserProfile` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID` (`ID`),
  CONSTRAINT `UserType` CHECK (((`UserType` = _utf8mb4'Staff') or (`UserType` = _utf8mb4'Customer')))
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `UserProfile` VALUES ('152846','Kevin','Adams','7827337828','k.adams@gmail.com','33 Norfolk Way','Customer'),('253647','Joe','Bloggs','7746338273','joey_bloggys@hotmail.com','28 Fairwood Road','Staff'),('625738','Alice','Andrews','7837229384','alice.a@hotmail.co.uk','1 Alnutt Street','Customer'),('746394','Rebecca','Smith','7717662722','becksmithy@gmail.com','565 London Road','Staff');
