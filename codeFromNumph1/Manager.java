...
public class Manager extends Staff{
     ...
     * @param lastName_
     */
    public Manager(final String userID_, final String firstName_, final String lastName_){
     ...
     * @param lastName_
     */
    public void setStaffProfile(final String userID_, final String firstName_, final String lastName_){
